...
import 'package:collevo_teacher/utilities/dialogs/invalid_email_dialog.dart';
                          ...
                          onPressed: () async {
                            ...
                            if (!isWhitelisted) {
                              await showInvalidEmailDialog(
                                context,
                                'Entered email is not a valid teacher MBCET email id. If you think this is a mistake, please contact the developer.',
                              );
                            } else {
